...
import dio.budgeting.infrastructure.http.response.BalanceResponse;
...
public class TransactionController {
    ...
    @GetMapping("/balance")
    public BalanceResponse readTotalBalance() {
        return new BalanceResponse(calculateTotalBalanceUseCase.execute());
    }
